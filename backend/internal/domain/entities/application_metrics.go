...
// ApplicationMetrics represents the application_metrics table
...
// TableName specifies the table name for ApplicationMetrics
func (ApplicationMetrics) TableName() string {
