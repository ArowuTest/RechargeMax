...
CREATE POLICY "templates_select_public" ON public.notification_templates
...
-- Notification Templates
CREATE INDEX idx_notification_templates_template_key ON public.notification_templates(template_key);
...
CREATE INDEX idx_user_notifications_reference ON public.user_notifications(reference_type, reference_id);
...
CREATE INDEX idx_delivery_log_status ON public.notification_delivery_log(delivery_status);
CREATE INDEX idx_delivery_log_attempted_at ON public.notification_delivery_log(attempted_at DESC);

-- User Preferences
CREATE INDEX idx_user_preferences_user_id ON public.user_notification_preferences(user_id);
