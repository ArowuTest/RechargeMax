...
INSERT INTO public.network_configs_2026_01_30_14_00 (
...
-- MTN Data Plans
INSERT INTO public.data_plans_2026_01_30_14_00 (
...
INSERT INTO public.wheel_prizes_2026_01_30_14_00 (
...
INSERT INTO public.admin_users_2026_01_30_14_00 (
...
INSERT INTO public.daily_subscription_config_2026_01_30_14_00 (
...
INSERT INTO public.platform_settings_2026_01_30_14_00 (
...
INSERT INTO public.draws_2026_01_30_14_00 (
...
INSERT INTO public.transactions_2026_01_30_14_00 (
    ...
    (
        uuid_generate_v4(),
        (SELECT id FROM public.users_2026_01_30_14_00 WHERE msisdn = '2348012345678'),
        '2348012345678',
        'MTN',
        'AIRTIME',
        1000.00,
    ...
    (
        uuid_generate_v4(),
        (SELECT id FROM public.users_2026_01_30_14_00 WHERE msisdn = '2348087654321'),
        '2348087654321',
        'AIRTEL',
        'DATA',
        2000.00,
...
INSERT INTO public.spin_results_2026_01_30_14_00 (
    ...
    (
        uuid_generate_v4(),
        (SELECT id FROM public.users_2026_01_30_14_00 WHERE msisdn = '2348012345678'),
        (SELECT id FROM public.transactions_2026_01_30_14_00 WHERE msisdn = '2348012345678' LIMIT 1),
        '2348012345678',
        (SELECT id FROM public.wheel_prizes_2026_01_30_14_00 WHERE prize_name = '₦100 Cash Prize' LIMIT 1),
        '₦100 Cash Prize',
        'CASH',
        100.00,
        'PENDING',
...
INSERT INTO public.daily_subscriptions_2026_01_30_14_00 (
...
-- Sample affiliate
INSERT INTO public.affiliates_2026_01_30_14_00 (
    id, user_id, affiliate_code, status, tier, commission_rate, 
    total_referrals, active_referrals, total_commission, approved_at
) VALUES 
    (
        uuid_generate_v4(),
        (SELECT id FROM public.users_2026_01_30_14_00 WHERE msisdn = '2347012345678'),
        'MIKE2026AFF',
        'APPROVED',
        'SILVER',
        7.50,
...
UPDATE public.users_2026_01_30_14_00 SET 
    total_recharge_amount = (
        SELECT COALESCE(SUM(amount), 0) 
        FROM public.transactions_2026_01_30_14_00 
        WHERE user_id = users_2026_01_30_14_00.id AND status = 'SUCCESS'
    ),
    total_transactions = (
        SELECT COUNT(*) 
        FROM public.transactions_2026_01_30_14_00 
...
SELECT 
    uuid_generate_v4(),
    (SELECT id FROM public.draws_2026_01_30_14_00 WHERE type = 'DAILY' AND status = 'ACTIVE' LIMIT 1),
    ds.user_id,
    ds.msisdn,
    ds.draw_entries_earned,
    'SUBSCRIPTION',
    ds.id
FROM public.daily_subscriptions_2026_01_30_14_00 ds
WHERE ds.status = 'active';

-- Update draw total entries
UPDATE public.draws_2026_01_30_14_00 SET 
    total_entries = (
        SELECT COALESCE(SUM(entries_count), 0) 
        FROM public.draw_entries_2026_01_30_14_00 
        WHERE draw_id = draws_2026_01_30_14_00.id
    );
