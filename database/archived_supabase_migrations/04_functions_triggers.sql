...
BEGIN
    ...
    -- Ensure uniqueness
    WHILE EXISTS (SELECT 1 FROM public.users_2026_01_30_14_00 WHERE referral_code = final_code) LOOP
        counter := counter + 1;
...
BEGIN
    ...
    FROM public.platform_settings_2026_01_30_14_00 
...
BEGIN
    ...
    SELECT 
        ...
        wp.icon_name,
        wp.color_scheme
    FROM public.wheel_prizes_2026_01_30_14_00 wp
...
BEGIN
    ...
    FROM public.users_2026_01_30_14_00 
    WHERE auth_user_id = p_auth_user_id OR msisdn = p_msisdn;
    
    IF user_id IS NOT NULL THEN
        -- Update existing user
        UPDATE public.users_2026_01_30_14_00 
        SET 
    ...
    ELSE
        ...
        INSERT INTO public.users_2026_01_30_14_00 (
...
BEGIN
    ...
    FROM public.transactions_2026_01_30_14_00
...
BEGIN
    ...
    UPDATE public.transactions_2026_01_30_14_00
    SET 
    ...
    IF transaction_record.amount >= spin_wheel_minimum THEN
        ...
        IF FOUND THEN
            INSERT INTO public.spin_results_2026_01_30_14_00 (
    ...
    IF draw_entries > 0 THEN
        INSERT INTO public.draw_entries_2026_01_30_14_00 (
        ...
        SELECT 
            ...
            'TRANSACTION',
            p_transaction_id
        FROM public.draws_2026_01_30_14_00 d
...
BEGIN
    ...
    IF p_affiliate_code IS NOT NULL THEN
        ...
        FROM public.affiliates_2026_01_30_14_00
    ...
    ELSIF transaction_record.user_id IS NOT NULL THEN
        ...
        FROM public.affiliates_2026_01_30_14_00 a
        JOIN public.users_2026_01_30_14_00 u ON u.referred_by = a.user_id
    ...
    INSERT INTO public.affiliate_commissions_2026_01_30_14_00 (
    ...
    UPDATE public.affiliates_2026_01_30_14_00
    SET 
...
BEGIN
    ...
    FROM public.draws_2026_01_30_14_00
    ...
    FROM public.draw_entries_2026_01_30_14_00
    ...
    FOR i IN 1..winners_needed LOOP
        ...
        FOR entry_record IN 
            ...
            FROM public.draw_entries_2026_01_30_14_00 de
        ...
        LOOP
            ...
            IF current_position >= random_position THEN
                ...
                IF NOT (entry_record.user_id = ANY(selected_entries)) THEN
                    ...
                    INSERT INTO public.draw_winners_2026_01_30_14_00 (
    ...
    -- Update draw status
    UPDATE public.draws_2026_01_30_14_00
    SET 
        status = 'COMPLETED',
        completed_at = NOW(),
        updated_at = NOW()
...
CREATE TRIGGER update_draw_entries_trigger
    AFTER INSERT OR UPDATE OR DELETE ON public.draw_entries_2026_01_30_14_00
...
CREATE TRIGGER process_transaction_trigger
    AFTER UPDATE ON public.transactions_2026_01_30_14_00
...
BEGIN
    RETURN QUERY
    SELECT 
        (SELECT COUNT(*)::INTEGER FROM public.users_2026_01_30_14_00 WHERE is_active = true),
        (SELECT COUNT(*)::INTEGER FROM public.transactions_2026_01_30_14_00 WHERE status = 'SUCCESS'),
        (SELECT COALESCE(SUM(amount), 0) FROM public.transactions_2026_01_30_14_00 WHERE status = 'SUCCESS'),
        (SELECT COUNT(*)::INTEGER FROM public.affiliates_2026_01_30_14_00 WHERE status = 'APPROVED'),
        (SELECT COUNT(*)::INTEGER FROM public.spin_results_2026_01_30_14_00 WHERE claim_status = 'PENDING'),
        (SELECT COUNT(*)::INTEGER FROM public.draws_2026_01_30_14_00 WHERE status = 'ACTIVE');
END;
$$ LANGUAGE plpgsql SECURITY DEFINER;
...
BEGIN
    ...
    SELECT 
        ...
        u.total_points,
        u.loyalty_tier,
        (SELECT COUNT(*)::INTEGER FROM public.spin_results_2026_01_30_14_00 WHERE user_id = p_user_id AND claim_status = 'PENDING'),
        (SELECT COALESCE(SUM(entries_count), 0)::INTEGER FROM public.draw_entries_2026_01_30_14_00 WHERE user_id = p_user_id),
        (SELECT COALESCE(SUM(commission_amount), 0) FROM public.affiliate_commissions_2026_01_30_14_00 ac 
         JOIN public.affiliates_2026_01_30_14_00 a ON a.id = ac.affiliate_id 
         WHERE a.user_id = p_user_id AND ac.status = 'APPROVED')
    FROM public.users_2026_01_30_14_00 u
