...
CREATE TABLE IF NOT EXISTS public.affiliate_analytics_2026_01_30_14_00 (
...
-- Analytics Indexes
CREATE INDEX idx_affiliate_analytics_affiliate_id ON public.affiliate_analytics_2026_01_30_14_00(affiliate_id);
CREATE INDEX idx_affiliate_analytics_date ON public.affiliate_analytics_2026_01_30_14_00(analytics_date);
CREATE INDEX idx_affiliate_analytics_conversions ON public.affiliate_analytics_2026_01_30_14_00(conversions);

-- ============================================================================
-- AFFILIATE BANK ACCOUNTS TABLE
-- ============================================================================

CREATE TABLE IF NOT EXISTS public.affiliate_bank_accounts_2026_01_30_14_00 (
    -- Primary identification
    id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
    ...
    verified_by UUID REFERENCES public.admin_users_2026_01_30_14_00(id),
...
CREATE INDEX idx_affiliate_bank_accounts_affiliate_id ON public.affiliate_bank_accounts_2026_01_30_14_00(affiliate_id);
CREATE INDEX idx_affiliate_bank_accounts_is_verified ON public.affiliate_bank_accounts_2026_01_30_14_00(is_verified);
CREATE INDEX idx_affiliate_bank_accounts_is_primary ON public.affiliate_bank_accounts_2026_01_30_14_00(is_primary) WHERE is_primary = true;
...
CREATE TRIGGER trigger_update_affiliate_analytics_timestamp
    BEFORE UPDATE ON public.affiliate_analytics_2026_01_30_14_00
    FOR EACH ROW
...
CREATE TRIGGER trigger_update_affiliate_bank_account_timestamp
    BEFORE UPDATE ON public.affiliate_bank_accounts_2026_01_30_14_00
    FOR EACH ROW
...
BEGIN
    IF NEW.is_primary = true THEN
        UPDATE public.affiliate_bank_accounts_2026_01_30_14_00
...
CREATE TRIGGER trigger_ensure_single_primary_bank_account
    BEFORE INSERT OR UPDATE ON public.affiliate_bank_accounts_2026_01_30_14_00
    FOR EACH ROW
...
BEGIN
    ...
    FROM public.affiliate_clicks_2026_01_30_14_00
    ...
    INSERT INTO public.affiliate_analytics_2026_01_30_14_00 (
        affiliate_id,
        analytics_date,
        total_clicks,
        unique_clicks,
...
BEGIN
    ...
    SELECT 
        ...
        (SELECT analytics_date FROM public.affiliate_analytics_2026_01_30_14_00 
         WHERE affiliate_id = p_affiliate_id 
         ORDER BY total_commission DESC LIMIT 1),
        (SELECT total_commission FROM public.affiliate_analytics_2026_01_30_14_00 
         WHERE affiliate_id = p_affiliate_id 
         ORDER BY total_commission DESC LIMIT 1)
    FROM public.affiliate_analytics_2026_01_30_14_00 a
...
COMMENT ON TABLE public.affiliate_analytics_2026_01_30_14_00 IS 'Daily analytics for affiliate performance tracking';
COMMENT ON TABLE public.affiliate_bank_accounts_2026_01_30_14_00 IS 'Bank account details for affiliate payouts';
COMMENT ON COLUMN public.affiliate_bank_accounts_2026_01_30_14_00.is_primary IS 'Primary bank account for payouts (only one per affiliate)';
