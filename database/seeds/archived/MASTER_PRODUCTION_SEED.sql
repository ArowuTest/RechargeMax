-- ============================================================================
-- RECHARGEMAX MASTER PRODUCTION SEED DATA
-- ============================================================================
-- This file contains ALL essential data needed for a production-ready platform
-- Part 1: Essential reference data (networks, plans, tiers, prizes, admin)
-- Part 2: Test/demo data (1,000 users, 5,000+ transactions)
-- ============================================================================
...
-- ============================================================================
-- 1.3 SUBSCRIPTION TIERS (4 loyalty tiers)
-- ============================================================================
...
('750e8400-e29b-41d4-a716-446655440001', 'BRONZE', 'Entry level tier for new users', 0.00, '{"spins": 1, "points": "1x", "commission": "0%"}', 1, 1.0, 0.0, 0, 1, true, NOW(), NOW()),
('750e8400-e29b-41d4-a716-446655440002', 'SILVER', 'Intermediate tier for regular users', 0.00, '{"spins": 2, "points": "1.5x", "commission": "5%"}', 2, 1.5, 5.0, 500000, 2, true, NOW(), NOW()),
('750e8400-e29b-41d4-a716-446655440003', 'GOLD', 'Advanced tier for power users', 0.00, '{"spins": 3, "points": "2x", "commission": "10%"}', 3, 2.0, 10.0, 1000000, 3, true, NOW(), NOW()),
('750e8400-e29b-41d4-a716-446655440004', 'PLATINUM', 'Premium tier for VIP users', 0.00, '{"spins": 5, "points": "3x", "commission": "15%"}', 5, 3.0, 15.0, 5000000, 4, true, NOW(), NOW());
...
('850e8400-e29b-41d4-a716-446655440001', 'Better Luck Next Time', 'NONE', 0, 40.50, true, 1, NOW(), NOW()),
('850e8400-e29b-41d4-a716-446655440002', '10 Points', 'POINTS', 10, 25.00, true, 2, NOW(), NOW()),
('850e8400-e29b-41d4-a716-446655440003', '25 Points', 'POINTS', 25, 15.00, true, 3, NOW(), NOW()),
('850e8400-e29b-41d4-a716-446655440004', '50 Points', 'POINTS', 50, 8.00, true, 4, NOW(), NOW()),
('850e8400-e29b-41d4-a716-446655440005', '100 Points', 'POINTS', 100, 5.00, true, 5, NOW(), NOW()),
('850e8400-e29b-41d4-a716-446655440006', '₦50 Airtime', 'AIRTIME', 50, 3.00, true, 6, NOW(), NOW()),
('850e8400-e29b-41d4-a716-446655440007', '₦100 Airtime', 'AIRTIME', 100, 1.50, true, 7, NOW(), NOW()),
('850e8400-e29b-41d4-a716-446655440008', '₦200 Airtime', 'AIRTIME', 200, 0.75, true, 8, NOW(), NOW()),
('850e8400-e29b-41d4-a716-446655440009', '₦500 Airtime', 'AIRTIME', 500, 0.50, true, 9, NOW(), NOW()),
('850e8400-e29b-41d4-a716-446655440010', '500MB Data', 'DATA', 500, 0.30, true, 10, NOW(), NOW()),
('850e8400-e29b-41d4-a716-446655440011', '1GB Data', 'DATA', 1000, 0.20, true, 11, NOW(), NOW()),
('850e8400-e29b-41d4-a716-446655440012', '2GB Data', 'DATA', 2000, 0.10, true, 12, NOW(), NOW()),
('850e8400-e29b-41d4-a716-446655440013', '₦1,000 Cash', 'CASH', 1000, 0.10, true, 13, NOW(), NOW()),
('850e8400-e29b-41d4-a716-446655440014', '₦5,000 Cash', 'CASH', 5000, 0.03, true, 14, NOW(), NOW()),
('850e8400-e29b-41d4-a716-446655440015', 'iPhone 15 Pro', 'PHYSICAL', 500000, 0.02, true, 15, NOW(), NOW());
...
\echo '--- Part 2: Loading Test/Demo Data ---'
\echo 'This will take a moment...'
\echo ''

-- Load the production_seed_final.sql file for test data
\i /home/ubuntu/RechargeMax_Updated/database/seeds/production_seed_final.sql
...
\echo '  ✓ 4 Subscription Tiers (Bronze, Silver, Gold, Platinum)'
\echo '  ✓ 15 Wheel Prizes'
\echo '  ✓ 1 Admin User (admin@rechargemax.ng)'
\echo '  ✓ 1,000 Test Users'
\echo '  ✓ 5,000+ Test Transactions'
\echo '========================================================================'
\echo 'Platform is ready for testing and demo!'
\echo '========================================================================'
