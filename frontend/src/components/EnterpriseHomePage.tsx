    ...
    <div className="min-h-screen bg-white overflow-x-hidden">
      ...
      <section id="about" className="py-16 bg-white">
        <div className="max-w-3xl mx-auto px-4">
          <h2 className="text-3xl font-bold text-gray-900 mb-6">About RechargeMax</h2>
          <p className="text-gray-600 leading-relaxed mb-4">
            <strong>RechargeMax</strong> is a product of <strong>Sherborne Consults Nigeria Limited</strong>, a technology company incorporated in Nigeria and committed to delivering innovative digital solutions for everyday Nigerians.
          </p>
          <p className="text-gray-600 leading-relaxed mb-4">
            RechargeMax is Nigeria's leading gamified mobile recharge platform. We make it easy and rewarding to top up airtime and data for all four major networks — MTN, Airtel, Glo, and 9mobile — while giving users the chance to win instant prizes, enter daily draws, and earn loyalty points on every recharge.
          </p>
          <p className="text-gray-600 leading-relaxed mb-4">
            Our mission is to turn a routine transaction into an exciting, value-packed experience. Every recharge is a chance to win cash prizes, free airtime, data bundles, and exclusive gifts through our spin wheel and daily draw competitions.
          </p>
          <p className="text-gray-600 leading-relaxed">
            Headquartered at 46 Oyibo Adjerho, Lekki Phase 1, Lagos, Nigeria, Sherborne Consults Nigeria Limited operates RechargeMax with a commitment to security, transparency, and customer satisfaction.
          </p>
        </div>
      </section>
      ...
      <section id="terms" className="py-16 bg-gray-50">
        <div className="max-w-3xl mx-auto px-4">
          ...
          <div className="space-y-6 text-gray-600 text-sm leading-relaxed">
            <div>
              <h3 className="font-semibold text-gray-800 mb-2">1. About the Platform</h3>
              <p>RechargeMax is a product of Sherborne Consults Nigeria Limited (&quot;the Company&quot;, &quot;we&quot;, &quot;us&quot;). By accessing or using the RechargeMax platform, you agree to be bound by these Terms of Service.</p>
            </div>
            <div>
              <h3 className="font-semibold text-gray-800 mb-2">2. Eligibility</h3>
              <p>You must be at least 18 years of age and a resident of Nigeria to use this platform. By registering, you confirm that all information provided is accurate and complete.</p>
            </div>
            <div>
              <h3 className="font-semibold text-gray-800 mb-2">3. Recharge Services</h3>
              <p>RechargeMax facilitates airtime and data top-ups for MTN, Airtel, Glo, and 9mobile. All recharges are processed in real time. Once a recharge is initiated and payment confirmed, it cannot be reversed. In the event of a failed delivery, our support team will investigate and resolve within 24 hours.</p>
            </div>
            <div>
              <h3 className="font-semibold text-gray-800 mb-2">4. Prizes, Draws &amp; Spin Wheel</h3>
              <p>Prize eligibility is determined by qualifying recharge amounts as defined by the platform. All draws and spin wheel results are generated by a certified random number system. Prizes are subject to availability. Cash prizes are disbursed to verified Nigerian bank accounts only. The Company reserves the right to withhold prizes pending identity verification.</p>
            </div>
            <div>
              <h3 className="font-semibold text-gray-800 mb-2">5. Loyalty Points</h3>
              <p>Loyalty points are awarded on qualifying recharges and may be redeemed for benefits as specified on the platform. Points have no cash value and cannot be transferred between accounts.</p>
            </div>
            <div>
              <h3 className="font-semibold text-gray-800 mb-2">6. Prohibited Conduct</h3>
              <p>You may not use the platform for fraudulent transactions, attempt to manipulate prize outcomes, create multiple accounts, or engage in any activity that violates Nigerian law. Violations will result in immediate account suspension and forfeiture of all prizes and points.</p>
            </div>
            <div>
              <h3 className="font-semibold text-gray-800 mb-2">7. Privacy</h3>
              <p>We collect and process your personal data in accordance with the Nigeria Data Protection Regulation (NDPR). Your data is used solely to provide and improve our services and will never be sold to third parties.</p>
            </div>
            <div>
              <h3 className="font-semibold text-gray-800 mb-2">8. Limitation of Liability</h3>
              <p>Sherborne Consults Nigeria Limited shall not be liable for any indirect, incidental, or consequential damages arising from your use of the platform. Our total liability shall not exceed the value of the transaction in dispute.</p>
            </div>
            <div>
              <h3 className="font-semibold text-gray-800 mb-2">9. Governing Law</h3>
            ...
            <div>
              ...
              <p>For enquiries, contact us at 46 Oyibo Adjerho, Lekki Phase 1, Lagos or call +2348187114229.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-screen-xl mx-auto px-4">
          <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-8 mb-8">
            <div>
              ...
              <p className="text-xs leading-relaxed mt-2 text-gray-500">RechargeMax is a product of <span className="text-gray-400 font-medium">Sherborne Consults Nigeria Limited</span>.</p>
            </div>
            <div>
            ...
            <div>
              ...
              <ul className="space-y-3 text-xs">
                ...
                <li className="flex items-center gap-2">
                  ...
                  <span>+2348187114229</span>
                </li>
              </ul>
            </div>
          </div>
          <div className="border-t border-gray-800 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs">
            <p>© 2026 RechargeMax — a product of <span className="text-gray-400">Sherborne Consults Nigeria Limited</span>. All rights reserved. 🇳🇬</p>
