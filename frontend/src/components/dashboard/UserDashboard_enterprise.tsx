...
export const UserDashboard: React.FC = () => {
  ...
  console.log('[UserDashboard] Auth context loaded:', { user, isAuthenticated });
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold">{dashboardData.user.total_recharges}</p>
                </div>
